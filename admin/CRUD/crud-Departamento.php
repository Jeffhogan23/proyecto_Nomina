...
<head>
    ...
    <title>Administrador | Departamento</title>
    ...
    <div class="container-fluid">
        ...
        <div class="main-content">
            <div class="crud-container">
                <h2 style="padding-left: 163px;" class="col-md-7">Departamento</h2>
                <div class="wrapper">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="section-content">
                                    ...
                                    <div class="col-md-3">
                                        <a href="Departamento/create-dep.php" class="btn btn-success">
                                            Agregar
                                        </a>
                                    </div>
                                </div>
                                            ...
                                            echo "<table style='margin-left: 15px; width: 1000px;' class='table table-bordered table-striped'>";
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    echo "<tr>";
                                                        ...
                                                        echo "<td>";
                                                            echo "<a href='Departamento/update-dep.php?id=" . $row['IDdep'] . "' title='Actualizar' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                                            echo "<a href='Departamento/delete-dep.php?id=" . $row['IDdep'] . "' title='Borrar' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                                        echo "</td>";
                                                    echo "</tr>";
                                                }
                                                echo "</tbody>";
