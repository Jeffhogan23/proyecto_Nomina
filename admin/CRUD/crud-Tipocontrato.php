...
<head>
    ...
    <title>Administrador | Tipo de Contrato</title>
    ...
    <div class="container-fluid">
        ...
        <div class="main-content">
            <div class="crud-container">
                <h2 style="padding-left: 163px;" class="col-md-7">Tipo de Contrato</h2>
                <div class="wrapper">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="section-content">
                                    ...
                                    <div class="col-md-3">
                                        <a href="Tipo_de_Contrato/create-tip-con.php" class="btn btn-success">
                                            Agregar
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            echo "<table style='margin-left: 15px; width: 1000px;' class='table table-bordered table-striped'>";
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    echo "<tr>";
                                                        echo "<td>" . $row['IDtipContrato'] . "</td>";
                                                        echo "<td>" . $row['NombreTipContrato'] . "</td>";
                                                        echo "<td>";
                                                            echo "<a href='Tipo_de_Contrato/update-tip-con.php?id=" . $row['IDtipContrato'] . "' title='Actualizar' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                                            echo "<a href='Tipo_de_Contrato/delete-tip-con.php?id=" . $row['IDtipContrato'] . "' title='Borrar' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                                        echo "</td>";
                                                    echo "</tr>";
                                                }
                                                echo "</tbody>";
